 ...
 * Devices Model
 *
 * @property \App\Model\Table\DeveicesTable&\Cake\ORM\Association\BelongsTo $Deveices
 ...
 */
class DevicesTable extends AppTable
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('Deveices', [
            'foreignKey' => 'deveice_id',
            'joinType' => 'INNER',
        ]);
    ...
    {
        $rules->add($rules->existsIn(['deveice_id'], 'Deveices'));
