...
/**
 * FoodDivisionsFixture
 */
class FoodDivisionsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'food_division_name' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '食事区分名', 'precision' => null, 'fixed' => null],
        ...
        'reserve_food_division' => ['type' => 'integer', 'length' => 5, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '予約食事区分', 'precision' => null, 'autoIncrement' => null],
