...
{
	var param = {};
	param.cardkbn = IC_CARD_RESERVATION;								// 処理区分
...
function insertCardInfo(tx, index)
{
	...
	var arr_info = card_id.split("-"); // ICカード番号-食事区分を分割

	//ICカードDBにレコード作成
	var sql = 'insert into ' + T_IC_CARD_LICENSE_TABLE_NAME + '(cardID,foodDivision) values (?,?)';
